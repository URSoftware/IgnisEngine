...
public final class GameFlowController extends IgnisScript {
    ...
    public void tick() {
        if (state == FlowState.MENU) {
            layoutMenu();
            if (isKeyJustPressed("ENTER")) beginExploration();
    ...
    private void showMainMenu() {
        ...
        startButton.setOnClick(this::beginExploration);
        layoutMenu();
    }
    ...
    private void beginExploration() {
        ...
        objectiveLabel = createLabel("Explore a Caverna do Selo. [E] interagir", 0, 20, 460, 26);
    ...
    private void layoutHud() {
        double width = Math.max(480, getGame().getWidth());
        objectiveLabel.setPosition((width - 460) / 2.0, 18);
